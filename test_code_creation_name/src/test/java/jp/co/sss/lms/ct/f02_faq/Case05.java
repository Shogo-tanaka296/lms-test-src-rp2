...
public class Case05 {
	...
	void test05() throws InterruptedException {
		...
		//検索ボタンの要素を取得
		WebElement keywordSearch = webDriver.findElement(By.cssSelector("input[type='submit'][value='検索']"));
		//検索フォームのクリア
		keywordForm.clear();
		//スクリーンショットにてエビデンス取得
		getEvidence(new Object() {},"入力後検索押下前");
		//検索フォームに文字列を入力
		keywordForm.sendKeys("研修");
		//スクリーンショットにてエビデンス取得
		getEvidence(new Object() {},"入力後検索押下後");
		//検索ボタンを押下
		keywordSearch.click();
	...
	void test06() {
		...
		scrollTo("-500");
		//スクリーンショットによるエビデンスの取得
		getEvidence(new Object() {},"クリアボタン押下前");
		//検索フォームの要素を取得
		WebElement keywordForm = webDriver.findElement(By.id("form"));
		//クリアボタンの要素を取得
		...
		clearButton.click();
		//スクリーンショットによるエビデンスの取得
		getEvidence(new Object() {},"クリアボタン押下後");
		//検索フォームが空かどうか確認
		assertTrue(keywordForm.getText().isEmpty());
	}
